...
<script type="text/javascript" src="<?php echo U(GROUP_NAME. '/Public/editor');?>"></script>
...
<div class="main">
	...
	<div class="form">
		<form method='post' id="form_do" name="form_do" action="<?php echo U(GROUP_NAME. '/Article/add');?>">
		<dl>
			<dt> 标题：</dt>
			<dd>
