...
<div class="main">
	...
	<div class="form">
		<form method='post' id="form_do" name="form_do" action="<?php echo U(GROUP_NAME. '/Abc/addDetail');?>">
		<dl>
			<dt>广告名称：</dt>
			<dd>
		...
		<dl>
            ...
            <dd>
                ...
                <input type="text" class="inp_one" name="starttime" id="starttime" value="<?php echo date('Y-m-d H:i:s',time());?>">
                <script type="text/javascript">
                    Calendar.setup({
                        weekNumbers: true,
		...
		<dl>
            ...
            <dd>
                ...
                <input type="text" class="inp_one" name="endtime" id="endtime" value="<?php echo date('Y-m-d H:i:s',strtotime('+1 months'));?>">
                <script type="text/javascript">
                    Calendar.setup({
                        weekNumbers: true,
                        inputField : "endtime",
        ...
        <?php switch($cate['type']): case "1": ?><dl>
			<dt>文字内容：</dt>
			<dd>
				<textarea name="content" class="tarea_default"></textarea>
			</dd>
		</dl><?php break;?>
	    <?php case "2": ?><dl>
			<dt> 图片：</dt>
			<dd>
				<div class="litpic_show">
				    ...
				    <input type="text" class="inp_w250" name="content" id="litpic"  value="" />
